...
public class HomeController extends Controller {
 ...
 public Result Service() {
        ...
        return ok(Service.render(getUserFromSession()));
    }

     public Result Enquiry() {

        return ok(Enquiry.render(getUserFromSession()));
    }
	
	 public Result LocateUs() {

        return ok(LocateUs.render(getUserFromSession()));
    }
	
	 public Result AskOurTeam() {

        return ok(AskOurTeam.render(getUserFromSession()));
    }
